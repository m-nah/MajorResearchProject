# -*- coding: utf-8 -*-
"""Models_Initialize.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1VDbPM8Rh2Q5o70dhtl5d3k6qa643vlgq
"""
...
GCN Model
'''
class GCNInitialize(nn.Module):
    def __init__(self, voc_size, emb_dim, dropout, adj, device=torch.device('cpu:0')):
        super(GCNInitialize, self).__init__()
...
class GCN(nn.Module):
    def __init__(self, vocab_size, ehr_adj, ddi_adj, emb_dim=64, dropout=0.5, device=torch.device('cpu:0'), ddi_in_memory=True):
        ...
        self.ehr_gcn = GCNInitialize(voc_size=vocab_size[2], emb_dim=emb_dim, dropout = dropout, adj=ehr_adj, device=device)
        self.ddi_gcn = GCNInitialize(voc_size=vocab_size[2], emb_dim=emb_dim,dropout = dropout, adj=ddi_adj, device=device)
